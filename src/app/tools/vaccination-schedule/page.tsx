...
export default function VaccinationSchedulePage() {
  ...
  return (
    <main className="flex-1 bg-white">
      ...
      <section className="bg-surface-tint border-b border-gray-100 py-10 print:hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="hidden print:block text-left border-b-2 border-primary-dark pb-6 mb-8 font-sans">
            <div className="flex justify-between items-start">
              <div>
                <h1 className="text-2xl font-bold text-primary-dark font-heading leading-none">
                  BABY STEPS
                </h1>
