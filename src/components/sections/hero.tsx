...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div 
        aria-hidden="true" 
        className="absolute inset-0 z-0 bg-[linear-gradient(180deg,rgba(244,248,255,0.45)_0%,rgba(244,248,255,0.25)_60%,transparent_100%)] md:bg-[linear-gradient(90deg,#F4F8FF_0%,rgba(244,248,255,0.92)_40%,rgba(244,248,255,0.4)_65%,transparent_100%)] pointer-events-none"
      />
